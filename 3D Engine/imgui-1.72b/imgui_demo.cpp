...
//            ImGui::Indent();
//
//            static bool horizontalList = true;
...
//            }
//
//            ImGui::Checkbox("Horizontal list", &horizontalList);
//
...
//                    if (ImGui::BeginDragDropSource(ImGuiDragDropFlags_SourceAllowNullID))
//                    {
//                        ImGui::SetDragDropPayload("color", &color, sizeof(color));
//                        ImGui::TextUnformatted(color);
//                        ImGui::EndDragDropSource();
//                    }
//                }
//
//                if (const ImGuiPayload* dropped = ImGui::AcceptReorderDropPayload("color", horizontalList ? ImGuiDragDropFlags_ReorderHorizontal : 0))
//                {
//                    // Move item after this one.
//                    memcpy(&color, dropped->Data, sizeof(color));
...
//
//        {
//            ImGui::BulletText("Drag to reorder/reparent a tree");
//            ImGui::Indent();
//
